...
## How to use the "random mode"?

I'm working on a different mode of this game, where it could be used without the need of a manual modification every week or so.
It's a prototype right now, but you can test it!
...
- [Play the random game here on GitHub](https://naereen.github.io/Can-you-guess-my-Scryfall-search-of-the-week-MTG/guess-a-random-query.html)
- ([Or random game here on my personal website](https://perso.crans.org/besson/publis/Can-you-guess-my-Scryfall-search-of-the-week-MTG/guess-a-random-query.html))
